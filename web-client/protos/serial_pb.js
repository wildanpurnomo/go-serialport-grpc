...
proto.protos.Response.toObject = function(includeInstance, msg) {
  var f, obj = {
    serialData: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
...
/**
 * optional string serial_data = 1;
 * @return {string}
 */
proto.protos.Response.prototype.getSerialData = function() {
 ...
 */
proto.protos.Response.prototype.setSerialData = function(value) {
